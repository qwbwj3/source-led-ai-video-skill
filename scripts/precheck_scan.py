...
用法：
  python3 scripts/precheck_scan.py --file 稿件.txt [--commercial] [--industry medical,finance] [--json]
  python3 scripts/precheck_scan.py --text "……"
...
TERMS_PATH = SKILL_ROOT / "scripts" / "precheck_terms.json"
MY_RULES_PATH = SKILL_ROOT / "references" / "publish-precheck" / "my-rules.md"
WORDLISTS_DIR = SKILL_ROOT / "references" / "publish-precheck" / "wordlists"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out", type=Path, help="把结果写入文件")
